...
public class VideoPlayerRecyclerView extends RecyclerView {
    ...
    public void playVideo(boolean isEndOfList) {
        ...
        VideoPlayerRecyclerAdapter.VideoPlayerViewHolder holder =
                (VideoPlayerRecyclerAdapter.VideoPlayerViewHolder) child.getTag();
        if (holder == null) {
            playPosition = -1;
            return;
        }
        ...
        String mediaUrl = mediaObjects.get(targetPosition).mediaUrl;
        if (mediaUrl != null) {
    ...
    private void animateVolumeControl(){
        if(volumeControl != null){
            ...
            if(volumeState == VolumeState.OFF){
                requestManager.load(R.drawable.ic_volume_off_grey)
                        .into(volumeControl);
            }
            else if(volumeState == VolumeState.ON){
                requestManager.load(R.drawable.ic_volume_up_grey)
                        .into(volumeControl);
            }
